...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    BoundClosure_evalRecipe(closure, recipe) {
      return A._Universe_evalInEnvironment(init.typeUniverse, A.instanceType(closure.__js_helper$_receiver), recipe);
    },
    ...
    Seat: function Seat(t0, t1, t2, t3) {
      var _ = this;
      _.number = t0;
      _.type = t1;
      _.reserved = t2;
    ...
    main() {
      var t1, seatsDiv, reserveButton, t2,
        bus = new A.Bus(A._setArrayType([], type$.JSArray_Seat));
      bus.Bus$0();
      t1 = document;
      seatsDiv = type$.DivElement._as(t1.querySelector("#seats"));
      A.displaySeats(seatsDiv, bus);
      reserveButton = type$.ButtonElement._as(t1.querySelector("#reserve-button"));
      t1 = type$._ElementEventStreamImpl_MouseEvent;
      t2 = t1._eval$1("~(1)?")._as(new A.main_closure(bus, seatsDiv));
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(reserveButton, "click", t2, false, t1._precomputed1);
    },
    displaySeats(seatsDiv, bus) {
      var t1, seatsTable, t2, t3, t4, t5, i, row, t6, t7, cell;
      B.DivElement_methods._clearChildren$0(seatsDiv);
      t1 = document;
      seatsTable = t1.createElement("table");
      for (t2 = bus.seats, t3 = type$.JSArray_Seat, t4 = type$.ArrayIterator_Seat, t5 = type$.Seat, i = 0; i < t2.length; ++i) {
        row = t1.createElement("tr");
        if (!(i < t2.length))
          return A.ioore(t2, i);
        t6 = new J.ArrayIterator(A._setArrayType([t2[i]], t3), 1, t4);
        for (; t6.moveNext$0();) {
          t7 = t6._current;
          if (t7 == null)
            t7 = t5._as(t7);
          ...
          if (t7.reserved) {
            B.TableCellElement_methods.set$text(cell, "X");
            t7 = cell.style;
            t7.backgroundColor = "gray";
          } else {
            B.TableCellElement_methods.set$text(cell, t7.number);
            t7 = cell.style;
            t7.backgroundColor = "green";
          }
          row.appendChild(cell);
        }
        seatsTable.appendChild(row);
      }
      seatsDiv.appendChild(seatsTable);
    },
  ...
  A.BoundClosure.prototype = {
    $eq(_, other) {
      ...
      if (!(other instanceof A.BoundClosure))
        return false;
      return this.$_target === other.$_target && this.__js_helper$_receiver === other.__js_helper$_receiver;
    },
    get$hashCode(_) {
      return (A.objectHashCode(this.__js_helper$_receiver) ^ A.Primitives_objectHashCode(this.$_target)) >>> 0;
    },
    toString$0(_) {
      return "Closure '" + this.$_name + "' of " + ("Instance of '" + A.Primitives_objectTypeName(this.__js_helper$_receiver) + "'");
    }
  };
  ...
  A.NoSuchMethodError.prototype = {
    toString$0(_) {
      ...
      receiverText = A.Error_safeToString(_this._receiver);
  ...
  A.Bus.prototype = {
    ...
    Bus$0() {
      var t1, i, t2;
      for (t1 = this.seats, i = 1; i <= 10; ++i) {
        t2 = "" + i;
        B.JSArray_methods.add$1(t1, new A.Seat(t2 + "A", "single", false, 50));
        B.JSArray_methods.add$1(t1, new A.Seat(t2 + "B", "double-aisle", false, 30));
        B.JSArray_methods.add$1(t1, new A.Seat(t2 + "C", "double-window", false, 40));
      }
    },
    reserveSeat$2(seatNumber, passengerName) {
      var t1, t2, i, t3, t4;
      for (t1 = this.seats, t2 = t1.length, i = 0; i < t2; ++i) {
        t3 = t1[i];
        t4 = t3.number;
        if (t4 === seatNumber)
          if (t3.reserved) {
            A.printString("Seat " + seatNumber + " is already reserved. Please choose a different seat.");
            return false;
          } else {
            t3.reserved = true;
            if (!(i < t1.length))
              return A.ioore(t1, i);
            A.printString("Seat " + t4 + " (" + t3.type + ") reserved for " + passengerName + ".");
            if (!(i < t1.length))
              return A.ioore(t1, i);
            A.printString("Seat cost: RM" + t1[i].price);
            return true;
          }
      }
      A.print("Invalid seat number. Please choose a seat from the available seats list.");
      return false;
    },
    noSuchMethod$1(_, invocation) {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t1, t2, seatInput, t3;
      type$.MouseEvent._as($event);
      t1 = document;
      t2 = type$.InputElement;
      seatInput = t2._as(t1.querySelector("#seat-input"));
      t3 = this.bus;
      if (t3.reserveSeat$2(seatInput.value.toUpperCase(), t2._as(t1.querySelector("#name-input")).value.toUpperCase()))
        A.displaySeats(this.seatsDiv, t3);
      else
        B.Window_methods.alert$1(window, "Sorry, that seat is already reserved. Please select another seat.");
      B.InputElement_methods.set$value(seatInput, "");
    },
    $signature: 12
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.ListMixin, A._UnmodifiableMapMixin, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator, A.Bus, A.Seat]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.DivElement, A.FormElement, A.InputElement, A.SelectElement, A.TableCellElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(Object?,Object?)", "~(Symbol0,@)", "~(Event)", "~(MouseEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"TypeError":[],"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"TableCellElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"Bus":{"Iterable":["Bus"]},"Seat":{"Iterable":["Seat"]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ArrayIterator_Seat: findType("ArrayIterator<Seat>"),
      ...
      JSArray_Seat: findType("JSArray<Seat>"),
